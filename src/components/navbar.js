      ...
      <div className="collapse navbar-collapse" id="collapsibleNavbar">
        <ul className="navbar-nav mx-auto">
          <li className="nav-item dropdown">
            ...
            >
              <NavLink to="/MeetingAndInfo" className="nav-link dropdown-item">
          ...
          <li className="nav-item dropdown">
            ...
            <div
              ...
              aria-labelledby="navbarDropdownMenuLink"
            >
              <NavLink to="/RotaryOverview" className="nav-link dropdown-item">
                Rotary overview
              </NavLink>
          ...
          <li className="nav-item dropdown">
            ...
            <div
              ...
              aria-labelledby="navbarDropdownMenuLink"
            >
              <NavLink to="/FeaturedCause" className="nav-link dropdown-item">
                Featured cause
              </NavLink>
              <NavLink to="/ServiceProjects" className="nav-link dropdown-item">
                Service projects
              </NavLink>
              <NavLink to="/Give" className="nav-link dropdown-item">
                Give
              </NavLink>
              <NavLink to="/BecomeAMember" className="nav-link dropdown-item">
                Become a member
              </NavLink>
          ...
          <li className="nav-item dropdown">
            ...
            >
              ...
              <NavLink to="/RotaryCalendar" className="nav-link dropdown-item">
                Rotary calendar
              </NavLink>
            </div>
          </li>
